...
for cv in ['block','standard']:
    for feature_list in feature_lists:
        ...
        for drug in ABRAccess.BasicDataObj.drugs:
            ...
            MLRG = RFClassifier(X_rep, Y)
            MLRG.tune_and_eval_predefined('/net/sgi/metagenomics/projects/pseudo_genomics/results/amr_toolkit/results/classifications_'+cv+'/'+drug+'_'.join(feature_list),final_isolates,'../temp_configs/cv3/'+cv+'_cv/'+drug+'_S-vs-R_folds.txt',njobs=50,feature_names=features)
