...
def single_drug_patterns(file_name, list_of_feature=['snps_all_envclin_trimmed_feature_vect', 'snps_all_full_trimmed','snps_nonsyn_trimmed' ,'snps_nonsyn_envclin_trimmed', 'gpa','genexp_count'], mapping={'0':0,'0.0':0,'1':1,'1.0':1}):
    '''
    :param file_name:
