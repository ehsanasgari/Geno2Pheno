...
TF=TextFeature(corpus, analyzer='char', ngram=(6,6), idf=False, norm='l1')

save_pref='/mounts/data/proj/asgari/github_data/data/pseudomonas/data_v2/extracted_features/seq_6_gram_no_idf'
