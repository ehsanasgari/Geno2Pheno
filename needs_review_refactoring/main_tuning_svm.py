...
#        KC=KFoldCrossVal(X,Y, folds=5, random_state=1, opt_f1_class=0)
#        KC.tune_and_evaluate(clf_svm, parameters, score='opt-f1', n_jobs=50, file_name='results/tuning/svm/kmer/9mer/9mer_5fold_'+drug)
